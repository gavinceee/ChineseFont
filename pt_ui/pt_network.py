...
class Block(nn.Module):
    def __init__(self, kernel_size, in_channels, out_channels, strides=1, padding='same', alpha=0.02):
...
class BlockGroup(nn.Module):
    def __init__(self, layers, kernel_size, in_channels, out_channels, strides=1, padding='same', alpha=0.02):
